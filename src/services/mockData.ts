...
export const INITIAL_USERS: User[] = [
  {
    id: 'usr-admin-1',
    name: 'Mario Henrique (PO / Admin)',
    email: 'mario.admin@vertice.com',
    role: 'admin',
    phone: '(11) 98888-1000',
  ...
  {
    id: 'usr-audit-1',
    name: 'Dra. Fernanda Audit',
    email: 'fernanda.auditoria@vertice.com',
    role: 'auditor',
    phone: '(11) 96666-3000',
